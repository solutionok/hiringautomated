        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="/{{auth()->user()->photo?auth()->user()->photo:'app/candidate/user.jpg'}}" class="img-circle" data-lock-picture="/{{auth()->user()->photo?auth()->user()->photo:'app/candidate/user.jpg'}}" />
                </figure>
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled">
                    <li class="divider"></li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="{{auth()->user()->isadmin>0?'/admin/settings':'/home/mypage'}}"><i class="fa fa-user"></i> {{auth()->user()->isadmin>0?'Settings':'Profile'}}</a>
                    </li>
                    <li>
